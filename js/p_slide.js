...
function changeSlide()
{
    ...
    imgIsLoaded = false;
    var htmlCont = "<center>" +
	"<img id=\"" + curImg + "\" src=\"" + imageSrcArray[curImg] + "\" title=\"" + imageNameArray[curImg] + "\"";
	...
	document.getElementById("ImageName").innerHTML = '<font size="2" face="Arial, Helvetica, sans-serif">'+
															imageNameArray[curImg] +'</font>';    
	if(imageDescArray[curImg] != '')
	{
		document.getElementById("ImageDesc").innerHTML ='<br><font size="2" face="Arial, Helvetica, sans-serif">'+
														imageDescArray[curImg] + '</font>';
	}
	else
	{
